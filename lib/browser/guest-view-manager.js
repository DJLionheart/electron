...
const attachGuest = function (event, embedderFrameId, elementInstanceId, guestInstanceId, params) {
  ...
  webViewManager.addGuest(guestInstanceId, elementInstanceId, embedder, embedderFrameId, guest, webPreferences)
...
ipcMain.on('ELECTRON_GUEST_VIEW_MANAGER_ATTACH_TO_EMBEDDER_FRAME', function (event, embedderFrameId, elementInstanceId, guestInstanceId, params) {
